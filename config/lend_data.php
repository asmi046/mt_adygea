...
return [
    ...
    'like_text' => "<strong>Наша страна</strong> — это бесконечный калейдоскоп живописных пейзажей, богатой истории и культуры. От величественных гор Кавказа до бескрайних просторов Сибири, от древних городов Золотого кольца до уникальных природных парков — каждый уголок России скрывает свои неповторимые сокровища. Откройте для себя всю красоту и величие нашей необъятной страны вместе с <strong>МирТуризма 46</strong>!",
];
